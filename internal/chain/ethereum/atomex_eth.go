...
// Initiate is a paid mutator transaction binding the contract method 0x48e558da.
//
// Solidity: function initiate(bytes32 _hashedSecret, address _participant, uint256 _refundTimestamp, uint256 _payoff) payable returns()
func (_AtomexEth *AtomexEthTransactor) Initiate(opts *bind.TransactOpts, _hashedSecret [32]byte, _participant common.Address, _refundTimestamp *big.Int, _payoff *big.Int) (*types.Transaction, error) {
	return _AtomexEth.contract.Transact(opts, "initiate", _hashedSecret, _participant, _refundTimestamp, _payoff)
}

// Initiate is a paid mutator transaction binding the contract method 0x48e558da.
//
// Solidity: function initiate(bytes32 _hashedSecret, address _participant, uint256 _refundTimestamp, uint256 _payoff) payable returns()
func (_AtomexEth *AtomexEthSession) Initiate(_hashedSecret [32]byte, _participant common.Address, _refundTimestamp *big.Int, _payoff *big.Int) (*types.Transaction, error) {
	return _AtomexEth.Contract.Initiate(&_AtomexEth.TransactOpts, _hashedSecret, _participant, _refundTimestamp, _payoff)
}

// Initiate is a paid mutator transaction binding the contract method 0x48e558da.
//
// Solidity: function initiate(bytes32 _hashedSecret, address _participant, uint256 _refundTimestamp, uint256 _payoff) payable returns()
func (_AtomexEth *AtomexEthTransactorSession) Initiate(_hashedSecret [32]byte, _participant common.Address, _refundTimestamp *big.Int, _payoff *big.Int) (*types.Transaction, error) {
	return _AtomexEth.Contract.Initiate(&_AtomexEth.TransactOpts, _hashedSecret, _participant, _refundTimestamp, _payoff)
}
